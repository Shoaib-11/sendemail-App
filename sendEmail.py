...
def sendEmail():
    try:
        if request.json['emailId'] is not None:
            ...
            contact_add = "ineuron@gmail.com"  ## the email id of the support team
            fromaddr = "sabtestbot123@gmail.com"   ## the email id from where we are going to send the mail
            ...
            # Authentication
            s.login(fromaddr, "Testbot@123")  # give your password here
